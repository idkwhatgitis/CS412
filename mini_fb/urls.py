...
urlpatterns = [
    ...
    path(r'profiles/create_status', views.CreateStatusMessageView.as_view(), name='URL_create_status'), #creating a message
    path(r'profiles/update', views.UpdateProfileView.as_view(), name='update_profile'), #updating profile
    ...
    path(r'profiles/add_friend/<int:other_pk>', views.CreateFriendView.as_view(), name='add_friend'), #creating friend view
    path(r'profiles/friend_suggestions', views.ShowFriendSuggestionsView.as_view(), name='friend_suggestions'), #view friend suggestions
    path(r'profiles/news_feed', views.ShowNewsFeedView.as_view(), name='news_feed'), #view news feed related to that person
